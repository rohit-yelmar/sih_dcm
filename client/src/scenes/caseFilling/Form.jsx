...
const Form = () => {
  ...
  const Case = async (values, onSubmitProps) => {
    ...
    const savedCaseResponse = await fetch(
      "http://localhost:5001/casecreate",
      {
        method: "POST",
        headers: {
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <TextField
                  ...
                  name="caseId"
                  error={
                    Boolean(touched.caseId) && Boolean(errors.caseId)
                  }
                ...
                <TextField
                  ...
                  name="issues"
                  error={
                    Boolean(touched.issues) && Boolean(errors.issues)
                  }
                ...
                <TextField
                  ...
                  name="laws"
                  error={
                    Boolean(touched.laws) && Boolean(errors.laws)
                  }
                ...
                <TextField
                  ...
                  name="lawType"
                  error={
                    Boolean(touched.lawType) && Boolean(errors.lawType)
                  }
                ...
                <TextField
                  ...
                  name="courtType"
                  error={
                    Boolean(touched.courtType) && Boolean(errors.courtType)
                  }
